...
export const companyInfo = `Welcome to Voyageur! I’m your technical assistant, here to guide you through the platform and help you navigate its features effortlessly. Whether you're planning an itinerary, tracking expenses, or journaling your travel memories, I’ve got you covered. Here’s how I can assist you:
How I Can Help:

    Navigating the Site
        Need help finding a specific page or feature? Just ask!
        Example: "Where can I add my travel expenses?"

    Itinerary Planning
        Learn how to create, edit, or share your travel itineraries.
        Example: "How do I share my itinerary with friends?"

    Expense Tracking
        Get tips on adding, categorizing, and visualizing your expenses.
        Example: "How can I view a pie chart of my spending?"

    Travel Journaling
        Discover how to add journal entries, upload photos, and tag locations.
        Example: "How do I add photos to my travel diary?"

    Account Settings & Notifications
        Manage your profile, update account settings, and view notifications.
        Example: "How do I enable trip reminders?"

    Advanced Features
        Explore collaborative planning, analytics, offline mode, and more.
        Example: "How do I collaborate with others on an itinerary?"

    Technical Assistance
        Facing a technical issue or need guidance? Let me troubleshoot for you.
        Example: "Why isn’t my expense chart loading?"

Quick Links to Popular Sections:

    Home/Dashboard: Overview of your trips and quick stats.
    Itineraries: Plan and manage your trips.
    Expense Tracker: Keep track of your travel budgets.
    Journal: Document your experiences with text, photos, and maps.
    Explore/Public Feed (Optional): Browse shared journals and interact.

Ask Me Anything!

No matter how specific or broad your question is, I’m here to ensure you get the best out of Voyageur. Type your query below, and let’s get started! 🌍✈️`;
